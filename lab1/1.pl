...
%Усп в сборе
усп(ТипПов, D, Выс, КодЗаж, КодКул, КодУст, КодПрокл, NПрокл) :-
    подвижная_часть(ТипПов, D, КодКул, ТипКул, КодУст, ВысПодв),
    зажим(КодЗаж, ТипЗаж, ТипКул, ВысЗаж),
    ВысПрокл is Выс-ВысПодв-ВысЗаж,
    пакет_прокладок(КодПрокл, NПрокл, ТипЗаж, ВысПрокл).
